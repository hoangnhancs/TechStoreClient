...
type Props<TFormData extends FieldValues> = {
    ...
    children: React.ReactNode //Các field của form (input, select,...) được truyền vào
    submitButtonText: string
    resolver: Resolver<TFormData> //schema validation
    reset?: boolean
}

export default function UserFormWrapper<TFormData extends FieldValues>({
    title,
    icon,
    onSubmit,
    children,

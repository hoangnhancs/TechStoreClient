...
namespace Persistence.Migrations
{
    ...
    public partial class InitTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProductTagFilters",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FilterTagValueId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductTagFilters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductTagFilters_FilterTagValues_FilterTagValueId",
                        column: x => x.FilterTagValueId,
                        principalTable: "FilterTagValues",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductTagFilters_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTagFilters_FilterTagValueId",
                table: "ProductTagFilters",
                column: "FilterTagValueId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductTagFilters_ProductId",
                table: "ProductTagFilters",
                column: "ProductId");

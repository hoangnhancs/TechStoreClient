...
{
    /// <inheritdoc />
    public partial class InitPostGréCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_filter_tags", x => x.id);
                    table.ForeignKey(
                        name: "fk_filter_tags_categories_category_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    old_price = table.Column<long>(type: "bigint", nullable: false),
                    price = table.Column<long>(type: "bigint", nullable: false),
                    discount_percentage = table.Column<long>(type: "bigint", nullable: false),
                    category_id = table.Column<int>(type: "integer", nullable: false),
                    ...
                    is_new_arrival = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    unit_sold = table.Column<int>(type: "integer", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    shipping_address_id = table.Column<string>(type: "text", nullable: true),
                    billing_address_id = table.Column<string>(type: "text", nullable: true),
                    sub_to_tal = table.Column<long>(type: "bigint", nullable: false),
                    shipping_cost = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "filter_tag_values",
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    value = table.Column<string>(type: "text", nullable: false),
                    filter_tag_id = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_filter_tag_values", x => x.id);
                    table.ForeignKey(
                        name: "fk_filter_tag_values_filter_tags_filter_tag_id",
                        column: x => x.filter_tag_id,
                        principalTable: "filter_tags",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_basket_item_baskets_basket_id",
                        column: x => x.basket_id,
                        principalTable: "baskets",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_basket_item_products_product_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_admin_comment = table.Column<bool>(type: "boolean", nullable: false),
                    has_admin_reply = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_product_display_tags", x => x.id);
                    table.ForeignKey(
                        name: "fk_product_display_tags_products_product_id",
                        column: x => x.product_id,
                        principalTable: "products",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "product_tag_filters",
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    product_id = table.Column<string>(type: "text", nullable: false),
                    filter_tag_value_id = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_product_tag_filters", x => x.id);
                    table.ForeignKey(
                        name: "fk_product_tag_filters_filter_tag_values_filter_tag_value_id",
                        column: x => x.filter_tag_value_id,
                        principalTable: "filter_tag_values",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "fk_product_tag_filters_products_product_id",
                        column: x => x.product_id,
                        principalTable: "products",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_filter_tag_values_filter_tag_id",
                table: "filter_tag_values",
                column: "filter_tag_id");

            migrationBuilder.CreateIndex(
                name: "ix_filter_tags_category_id",
                table: "filter_tags",
                column: "category_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_product_display_tags_product_id",
                table: "product_display_tags",
                column: "product_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_product_tag_filters_filter_tag_value_id",
                table: "product_tag_filters",
                column: "filter_tag_value_id");

            migrationBuilder.CreateIndex(
                name: "ix_product_tag_filters_product_id",
                table: "product_tag_filters",
                column: "product_id");
